...
function AddressCard(data) {
  return (
    <div className='col-sm-5 col-12 AddressBox mb-3 ms-2'>
        ...
        {
            data.isPrimary === true?(<button className='col-sm-3 col-4 col-lg-4 btn btn-danger ms-5 AddressBoxbtn'>Primary</button>) :(<button className='col-5 col-sm-6 col-lg-4 btn btn-danger ms-5 AddressBoxbtn'>Set as primary </button>)
        }
        </div>
